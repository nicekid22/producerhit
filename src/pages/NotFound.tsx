  ...
  return (
    <MarketingPageShell>
      ...
      <main className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <h1 className="mt-3 text-2xl font-bold tracking-tight text-white sm:text-3xl">{m.common.notFoundTitle}</h1>
        <p className="mt-3 text-sm leading-relaxed text-white/58">{m.common.notFoundBody}</p>
