...
const GROUP_ICON: Record<string, LucideIcon> = {
  ...
  "latin / caribbean / lusophone": Globe2,
  "latin wave 2": Globe2,
  "asia / pacific": Globe2,
  "middle east / gulf": Globe2,
  "k-pop & east asia": Radio,
  "maghreb & diaspora": Globe2,
  "africa / diaspora": Globe2,
  "rock / metal": Guitar,
  "country / folk": Guitar,
  "wellness / creator": Headphones,
  "cinematic / classical": Headphones,
  "phonk / club": Radio,
  "faith / americana": Guitar,
  "world / regional": Globe2,
