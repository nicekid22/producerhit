...
/**
 * Cloud Drip — nouvelle identité de marque (coral #FF5B35, ink #16151B, cloud #F4F0E8).
 * Remplace le violet/rose sur la landing et le dashboard quand actif.
 * Rollback : VITE_CLOUD_DRIP_THEME=0
 * @see producerhit-refonte-prompt.md §5 "Vision de marque — codenom CLOUD DRIP"
 */
export const CLOUD_DRIP_THEME_ENABLED = import.meta.env.VITE_CLOUD_DRIP_THEME !== "0";
