...
import type { GenerateParams } from "@producerhit/shared";
...
export function buildRichPrompt(params: GenerateParams, isSong: boolean = false) {
  ...
  const songGenreMap: Record<string, string> = {
    ...
    Bachata: "bachata, romantic nylon guitar arpeggios, bongo guira rhythm, Dominican slow dance, Spanish vocals",
    "Bachata Sensual": "bachata sensual, legato guitar, sensual body-wave pulse, intimate partner dance",
    Salsa: "salsa, clave montuno piano, congas timbales brass, high-energy Cuban dance",
    Kizomba: "kizomba, slow sensual pulse, romantic R&B chords, close-embrace Angolan dance",
    Dembow: "dembow, Dominican riddim, perreo 808 bounce, raw street-party energy",
    Cumbia: "cumbia, shuffle groove guiro tambora, accordion lead, Colombian festive dance",
    "Latin Pop": "latin pop, bilingual catchy chorus, urbano crossover, glossy pop hooks",
    Merengue: "merengue, fast tambora guira, accordion melody, Dominican party dance",
    "Worship Pop": "worship pop, uplifting anthemic chorus, spiritual hopeful major chords",
    "Country Pop": "country pop, acoustic Nashville crossover, storytelling chorus, pedal steel hooks",
    "Regional Mexican": "regional mexican, bajo sexto tuba accordion, norteño banda storytelling",
    Corridos: "corridos, nylon guitar narrative loop, tuba bass, Mexican regional storytelling vocals",
    Bollywood: "bollywood song, Hindi filmi orchestration, tabla sitar, cinematic strings, Hindi vocals",
    Bhangra: "bhangra song, dhol drums, Punjabi wedding energy, festive vocal hooks",
    Khaleeji: "khaleeji song, Gulf Arabic pop, oud darbuka groove, romantic Arabic melisma vocals",
    "Arabic Pop": "arabic pop song, quarter-tone hooks, synth brass, Arabic melismatic vocals",
    Mahraganat: "mahraganat song, Egyptian electro-shaabi, distorted synth, auto-tune Arabic chants",
    Shaabi: "shaabi song, Egyptian folk-pop accordion, tabla groove, call-response Arabic vocals",
    Dabke: "dabke song, Levantine line-dance groove, mijwiz darbuka stomp-clap, Arabic wedding chant vocals",
    "Gulf Trap": "gulf trap beat, Khaleeji trap crossover, sliding 808, Arabic scale synth lead",
    "Persian Pop": "persian pop song, santur tar pluck, daf groove, emotional Farsi vocals",
    "Turkish Pop": "turkish pop song, baglama arpeggios, darbuka drums, Turkish vocal belt chorus",
    "K-Pop Idol": "K-pop idol song, stacked harmonies, trap-pop drums, supersaw chorus drop, Korean vocals",
    "K-Pop Ballad": "K-pop ballad song, piano strings, emotional Korean vocal belt, OST drama mood",
    "J-Pop": "J-pop song, bright Tokyo synth hooks, catchy melody, Japanese vocals",
    Anison: "anison anime opening song, heroic chorus lift, fast drums, Japanese vocal belt",
    "City Pop": "city pop song, funky bass, synth brass, 80s Tokyo night-drive nostalgia",
    Ranchera: "ranchera song, mariachi trumpet, emotional Mexican serenade, Spanish vocals",
    "Contemporary Country": "contemporary country song, Nashville storytelling, acoustic-electric blend, English vocals",
