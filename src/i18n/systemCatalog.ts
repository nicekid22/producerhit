...
const BILLING = {
  ...
  checkoutUnavailable: L({
    en: "Checkout is temporarily unavailable — please try again in a moment.",
    fr: "Le paiement est temporairement indisponible — réessaie dans un instant.",
    es: "El pago no está disponible temporalmente — inténtalo de nuevo en un momento.",
    pt: "O checkout está temporariamente indisponível — tente novamente em instantes.",
    de: "Checkout vorübergehend nicht verfügbar — bitte gleich erneut versuchen.",
    it: "Il checkout è temporaneamente non disponibile — riprova tra poco.",
    nl: "Checkout is tijdelijk niet beschikbaar — probeer het zo opnieuw.",
    ar: "الدفع غير متاح مؤقتًا — حاول مرة أخرى بعد قليل.",
    ja: "チェックアウトは一時的に利用できません — しばらくしてから再度お試しください。",
    ko: "결제를 일시적으로 사용할 수 없습니다 — 잠시 후 다시 시도하세요.",
    tr: "Ödeme geçici olarak kullanılamıyor — lütfen biraz sonra tekrar deneyin.",
    hi: "चेकआउट अस्थायी रूप से अनुपलब्ध है — कृपया थोड़ी देर बाद पुनः प्रयास करें।",
    zh: "结账暂时不可用 — 请稍后再试。",
    th: "checkout ใช้งานไม่ได้ชั่วคราว — ลองอีกครั้งในอีกสักครู่",
  }),
  portalUnavailable: L({
