...
export const fr: BaseMessageCatalog = {
  nav: {
    ...
    blog: "Blog",
    login: "Connexion",
    startFree: "Essayer gratuit — sans carte",
  ...
  landing: {
    ...
    heroLead: "Décris une vibe → écoute un morceau fini en moins d'une minute. MP3 gratuit, WAV sur Pro.",
    heroReassurance: "10 morceaux free/mois · Sans carte · Aucun engagement",
    heroScrollCue: "Essaie maintenant — sans inscription pour prévisualiser",
    heroCtaPrimary: "Créer mon premier morceau free",
    heroCtaDashboard: "Ouvrir mon studio →",
    ctaTitle: "Transforme ta prochaine idée en track prête à sortir",
    ctaLead: "{{free}} générations gratuites / mois. Passe Pro ({{proPrice}}) pour WAV + droits commerciaux.",
    ctaButton: "Commencer free — créer maintenant →",
    modeSong: "Chanson",
    modeBeat: "Type Beat",
    modeAdvanced: "Options avancées",
    create: "Créer",
    generating: "Génération…",
    stayOnHome: "Rester sur l’accueil",
  },
  app: {
