...
const FR_SPECS: Spec[] = [
  ...
  { hook: "Fête surprise alors qu'ils pensaient être oubliés", genre: "pop R&B", captionGenre: "pop R&B", mood: "uplifting", instruments: "piano smooth, 808 bright, hi-hats trap, cuivres, pads chaleureux", bpm: 112 },
  ...
  { hook: "Trajet en bagnole, vitres ouvertes, playlist au hasard", genre: "pop rock", captionGenre: "pop rock", mood: "insouciant", instruments: "guitares driving, batterie steady, basse anthemique, chœurs gang, reverb open-air", bpm: 128 },
  { hook: "Promotion obtenue — on appelle toute l'équipe", genre: "trap motivante", captionGenre: "motivational trap", mood: "triomphant", instruments: "808 hard, hi-hats crisp, cuivres, stabs piano, énergie foule", bpm: 138 },
  ...
  { hook: "Journée plage — sable, crème solaire, zéro boulot en tête", genre: "reggaeton", captionGenre: "reggaeton", mood: "vibrant", instruments: "rythme dembow, plucks bright, basse chaude, cuivres été, ad-libs party", bpm: 96 },
  ...
  { hook: "Badge vérifié sur l'appli où tu bosses depuis des années", genre: "hyperpop", captionGenre: "hyperpop", mood: "extatique", instruments: "synthés glitch, 808 distordu, voix pitchées, leads laser, FX confettis", bpm: 155 },
  { hook: "Dîner en famille — examen réussi, fierté au menu", genre: "gospel pop", captionGenre: "gospel influenced", mood: "reconnaissant", instruments: "orgue, claps chœur, batterie live, basse walk, swells cuivres", bpm: 104 },
  { hook: "Rendez-vous à la patinoire — néons, boule disco, pas de téléphone", genre: "disco pop", captionGenre: "disco pop", mood: "fun rétro", instruments: "four-on-the-floor, basse funky, cordes, talk box, claps", bpm: 116 },
  ...
  { hook: "Coucher de soleil au festival — foule qui saute, bras tendus", genre: "EDM pop", captionGenre: "EDM", mood: "euphorique", instruments: "lead supersaw, kick festival, basse sidechain, FX foule, risers drop", bpm: 128 },
  ...
  { hook: "Apéro de quartier — grillades, enceintes sur le perron", genre: "boom bap", captionGenre: "boom bap", mood: "communauté", instruments: "chop jazz sample, drums boom bap, basse chaude, loop cuivres, ad-libs block", bpm: 92 },
  ...
  { hook: "Scène ouverte — mieux que prévu, salle debout", genre: "pop auteur", captionGenre: "singer-songwriter", mood: "fierté", instruments: "guitare acoustique, cajon, cordes légères, stomps, applaudissements", bpm: 96 },
  ...
  { hook: "Playlist de route — fausses paroles hurlées à fond", genre: "power pop", captionGenre: "power pop", mood: "fun total", instruments: "guitares crunch, drums driving, voix gang, leads octave, claps", bpm: 134 },
  ...
  { hook: "Premier jour au boulot de rêve — photo du badge, grand sourire", genre: "pop motivante", captionGenre: "motivational pop", mood: "prêt", instruments: "piano uplifting, drums punchy, montée cordes, cuivres, basse confiante", bpm: 116 },
  { hook: "Fête à la piscine — bombes, crème solaire, fous rires", genre: "tropical house", captionGenre: "tropical house", mood: "vacances", instruments: "marimba, four-on-the-floor, steel drum, plucks été, FX océan", bpm: 118 },
  ...
  { hook: "Projet livré — symbole champagne dans le groupe", genre: "pluggnb", captionGenre: "pluggnb", mood: "happy flottant", instruments: "bell plucks, 808 soft, pads airy, claps reverb, leads sparkle", bpm: 145 },
  { hook: "Skatepark avec la bande — nouvelle figure validée du premier coup", genre: "pop punk", captionGenre: "pop punk", mood: "rush jeunesse", instruments: "power chords, drums rapides, hook shouté, basse drive, woah foule", bpm: 168 },
  ...
  { hook: "Week-end hôtel sans quitter la ville — peignoir, room service, zéro culpabilité", genre: "R&B luxury", captionGenre: "luxury R&B", mood: "indulgent", instruments: "clés smooth, 808 deep, pads soie, trompette muted, FX champagne", bpm: 88 },
