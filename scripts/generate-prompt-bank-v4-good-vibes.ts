...
const FR_HOOKS: string[] = [
  ...
  "Le groupe WhatsApp te hype sans prévenir",
  "Le soleil perce les nuages pile au bon moment",
  "Karaoké — tu tiens la note aiguë",
  "Veste vintage qui tombe juste parfaitement",
  "Le boss dit prendre l'après-midi — payé",
  "Arc-en-ciel après l'orage sur le trajet",
  "Ton mème reposté par quelqu'un que tu admires",
  "Le café offre un gâteau parce que t'es régulier",
  "Shuffle playlist — la chanson parfaite deux fois",
  "Les kids t'ont dessiné super-héros sur le frigo",
  "Place de parking libre juste devant",
  "Album photo retrouvé avec les meilleurs souvenirs",
  "Inconnu te tient la porte — tu as illuminé sa journée",
  ...
  "Visio surprise avec des potes à travers le monde",
  "Nouvelle feuille sur la plante du matin au soir",
  "Compliment sur ta tenue par quelqu'un de stylé",
  "Musicien de rue joue ta chanson préférée",
  "Record à la salle alors que tu voulais skip",
  ...
  "Places gratuites pour le concert voulu",
  "Aide aux devoirs d'un frère qui te taquine d'habitude",
  "Trajet fluide — tous les feux au vert",
  "Camion de glaces le jour le plus chaud",
  "Plat végé qui impressionne les carnivores",
  "Flash mob et tu rejoins la danse",
  ...
  "Crush a liké ta story en deux minutes",
  "Vinyle vintage à deux euros en brocante",
  "Récolte du jardin communautaire généreuse",
  "Wi-Fi réparé avant la grosse réunion",
  "Bonus surprise sur la fiche de paie",
  "Photo montagnes russes — tout le monde hilare",
  "Nouvelle coupe — le barber a compris",
  "Beach volley avec des inconnus devenus potes",
  "Cadeau parfait trouvé au premier magasin",
  "Open mic — le host te rappelle pour un rappel",
  "Pneu de vélo tenu sur la plus longue sortie",
  "Sunset paddle avec des dauphins pas loin",
  "Coloc a nettoyé la cuisine sans qu'on demande",
  "Ta blague passe dans une salle de nouveaux",
  "Premier date rit de ton pire jeu de mots",
  "Livre voulu à la bibliothèque vient d'être rendu",
  "Contrôle passeport fluide — mode vacances ON",
  "Soldes sur les chaussures en favoris",
  "Coach te dit que tu progresses",
  "Pizza maison — pâte parfaitement levée",
  "Feux d'artifice depuis un rooftop secret",
  "Podcasteur répond gentiment à ton DM",
  "Bataille de boules de neige finie en câlins",
  "Cours de yoga fini sur la playlist du prof",
  "Trèfle à quatre feuilles trouvé en balade",
  "Ton art affiché sur le panneau du quartier",
  "Diner tardif entre potes après le film",
  "Première vague debout en surf",
  "Bénévolat raccourci grâce à la bonne compagnie",
  "Fleurs surprise sur le bureau au bureau",
  ...
  "Nouveau collègue exactement ton vibe",
  "Photos photomaton pleines de joie",
  "Premier gel — le monde semble magique",
  "Compliment du barista qui parle jamais",
  ...
  "Streak méditation cent jours",
  "Visite surprise d'un pote loin",
  ...
  "Flip brocante vendu triple le prix",
  "Présentation fluide — le client adore",
  "Banc avec la vue parfaite",
  "La plante fleurit enfin après patience",
  ...
  "Quiz gagné par un point",
  "Caisse fluide — zéro file",
  "Dessert offert par la maison",
  "Photos golden hour sans filtre",
  "Nouveau café favori trouvé par hasard",
  "Ta reco devient l'obsession de quelqu'un",
  "Première baignade de l'été — eau parfaite",
  "Compliment cuisine du difficile",
  "Trajet vélo avec vent dans le dos",
  "Playlist parfaite pour l'humeur du moment",
  "Ton idée retenue au brainstorming",
