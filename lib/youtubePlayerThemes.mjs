...
/** vibez → prism · market → warm-glass · override via YOUTUBE_PLAYER_THEME */
export function playerThemeForAccount(accountId) {
  ...
  if (id === "vibez") return "prism";
  if (id === "market") return "warm-glass";
  return "cinema";
}
...
export const PLAYER_THEMES = {
  ...
  prism: {
    ...
    card: {
      header: "ProducerHit",
      footer: "",
      panel: "rgba(12,10,32,0.76)",
      border: "rgba(103,195,255,0.22)",
      sheen0: "rgba(103,195,255,0.12)",
      sheen1: "rgba(157,124,255,0.04)",
      titleSize: 44,
      titleWeight: 700,
      titleStyle: "normal",
      titleFont: "Inter, 'Segoe UI', system-ui, sans-serif",
      subSize: 24,
      subColor: "rgba(103,195,255,0.62)",
      accent: "rgba(226,232,240,0.96)",
      barStroke: "rgba(103,195,255,0.28)",
      eqBarFill: "rgba(157,124,255,0.26)",
    },
  },
  "warm-glass": {
    id: "warm-glass",
    ...
    card: {
      header: "PLAYING FROM COMMUNITY",
      footer: "producerhit.com",
      panel: "rgba(38,16,10,0.58)",
      border: "rgba(255,195,150,0.28)",
      sheen0: "rgba(240,200,72,0.14)",
      sheen1: "rgba(216,88,120,0.05)",
      titleSize: 50,
      titleWeight: 400,
      titleStyle: "italic",
      titleFont: "Georgia, 'Times New Roman', serif",
      subSize: 24,
      subColor: "rgba(255,220,180,0.58)",
      accent: "rgba(255,248,240,0.94)",
      barStroke: "rgba(240,200,72,0.32)",
      eqBarFill: "rgba(232,120,56,0.28)",
    },
  },
};
...
export async function renderBrandWordmarkPng(themeId, cardY, outPath) {
  ...
  <text x="50%" y="30" text-anchor="middle" fill="${theme.wordmarkColor}" fill-opacity="${theme.wordmarkOpacity}"
    font-family="Arial, Helvetica, sans-serif" font-size="26" font-weight="700"
    stroke="black" stroke-opacity="0.45" stroke-width="1" paint-order="stroke">producerhit.com</text>
</svg>`;
