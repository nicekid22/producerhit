...
export const YOUTUBE_CHANNEL_PROFILES = {
  ...
  remix1: {
    ...
    channelKeywords: "ai remix, ai cover, trending song remix, music remix, ai music, producerhit",
  ...
  remix2: {
    ...
    channelKeywords: "ai cover, ai remix, viral song cover, trending music remix, producerhit",
