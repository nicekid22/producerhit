-- Profils créateurs publics : username_norm, bio, avatar, follows, RPCs.
-- Déploiement : Get-Content supabase/scripts/deploy_creator_profiles.sql -Raw | npx supabase db query --linked
